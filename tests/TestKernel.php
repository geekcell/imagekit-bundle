...
namespace GeekCell\ImagekitBundle\Tests;

use GeekCell\ImagekitBundle\GeekCellImagekitBundle;
...
class TestKernel extends Kernel
{
    ...
    public function registerBundles(): iterable
    {
        ...
        if (in_array($this->getEnvironment(), ['test'], true)) {
            $bundles[] = new GeekCellImagekitBundle();
        }
    ...
    {
        return sprintf(
            '%s/GeekCellImagekitBundle/cache/%s/%s',
            sys_get_temp_dir(),
            $this->randomHash,
            $this->getEnvironment(),
        );
    ...
    {
        return sys_get_temp_dir() . '/GeekCellImagekitBundle/logs';
    }
}
